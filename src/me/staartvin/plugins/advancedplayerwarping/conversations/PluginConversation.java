...
public class PluginConversation {
     ...
     */
    public PluginConversation(JavaPlugin plugin) {
     ...
     * @return an {@link PluginConversation} object so you can easily chain calls.
     */
    public static PluginConversation fromFirstPrompt(Prompt prompt) {
        JavaPlugin plugin = (JavaPlugin) Bukkit.getServer().getPluginManager().getPlugin("AdvancedPlayerWarping");

        PluginConversation conversation = new PluginConversation(plugin);
