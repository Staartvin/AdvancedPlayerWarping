...
public class ConfirmPrompt extends FixedSetPrompt {
     ...
     */
    public ConfirmPrompt(String message, Prompt confirmPrompt, Prompt denyPrompt,
     ...
     * @param denyPrompt    Prompt to go to if the conversable denies. If none is given, the conversation is ended.
     */
    public ConfirmPrompt(Prompt confirmPrompt, Prompt denyPrompt) {
     ...
     * @param confirmPrompt Prompt to go to if the conversable confirms.
     */
    public ConfirmPrompt(Prompt confirmPrompt) {
    ...
    @Override
    protected @Nullable
    Prompt acceptValidatedInput(@NotNull ConversationContext conversationContext,
                                @NotNull String s) {
